...
use strict;
use local::lib;
#use lib '/home/nagios/perl5/lib/perl5';
...
perl -e 'use strict; use local::lib; use lib "/home/nagios/lib/perl5"; my $module="Tree::Simple::VisitorFactory"; eval "require $module"; if ( !$@ ) { printf( "%-20s: %s\n", $module, $module->VERSION ) ; } else { printf("%-20s: NOT_FOUND\n", $module); }'

perl -e 'use strict; use local::lib; use lib "/home/rt/lib/"; use lib "/home/rt/lib/perl5/";
